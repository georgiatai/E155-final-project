...
![Waveform of the keypad scanner module `keypad_scanner`](images/testbench_keyscan_wave.png)

![Waveform of the keypad decoder module `keypad_decoder`](images/testbench_keydec_wave.png)

![Waveform of the FSM module `press_FSM`](images/testbench_pressFSM_wave.png)
