...
// Netlist written on Wed Dec  3 11:00:41 2025
...
//
// Verilog Description of module ramdp8b
// module wrapper written out since it is a black-box. 
//

//

module ramdp8b (wr_clk_i, rd_clk_i, rst_i, wr_clk_en_i, rd_en_i, rd_clk_en_i, 
            wr_en_i, wr_data_i, wr_addr_i, rd_addr_i, rd_data_o) /* synthesis ORIG_MODULE_NAME="ramdp8b", LATTICE_IP_GENERATED="1", cpe_box=1 */ ;
    input wr_clk_i;
    input rd_clk_i;
    input rst_i;
    input wr_clk_en_i;
